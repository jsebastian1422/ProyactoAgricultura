...
<div class="container">
    <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 login-img">
        ...
        <div class="cont_empre">
            <h1 class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">Nombre de la empresa</h1>
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 site-login">
        <!--<?= Html::encode($this->title) ?>-->
        <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-8 login">

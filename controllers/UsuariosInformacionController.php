...
use app\models\UsuariosInformacionSearch;
 ...
 */
class UsuariosInformacionController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new UsuariosInformacionSearch();
    ...
    {
        $model = new UsuariosInformacion();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->usuario_info]);
        }
    ...
    {
        if (($model = UsuariosInformacion::findOne($id)) !== null) {
            return $model;
        }
